...
export function PaginatedProviderListFromJSON(
  json: any
...
export function PaginatedProviderListFromJSONTyped(
  ...
  return {
    ...
    results: !exists(json, 'results')
      ? undefined
      : (json['results'] as Array<any>).map(ProviderFromJSON),
  }
}

export function PaginatedProviderListToJSON(
  ...
  return {
    ...
    results:
      value.results === undefined
        ? undefined
        : (value.results as Array<any>).map(ProviderToJSON),
  }
}
