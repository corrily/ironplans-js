...
export function BulkCreateInviteRequestFromJSON(
  json: any
): BulkCreateInviteRequest {
  return BulkCreateInviteRequestFromJSONTyped(json, false)
}

export function BulkCreateInviteRequestFromJSONTyped(
  json: any,
  ...
  return {
    sentToEmail: !exists(json, 'sent_to_email')
      ? undefined
      : json['sent_to_email'],
...
export function BulkCreateInviteRequestToJSON(
  value?: BulkCreateInviteRequest | null
): any {
  if (value === undefined) {
    return undefined
  }
