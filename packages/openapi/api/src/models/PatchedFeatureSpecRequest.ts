...
export function PatchedFeatureSpecRequestFromJSON(
  json: any
): PatchedFeatureSpecRequest {
  return PatchedFeatureSpecRequestFromJSONTyped(json, false)
}

export function PatchedFeatureSpecRequestFromJSONTyped(
  json: any,
...
export function PatchedFeatureSpecRequestToJSON(
  value?: PatchedFeatureSpecRequest | null
): any {
  if (value === undefined) {
    return undefined
  }
