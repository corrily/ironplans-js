...
export function PatchedPlanRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    features: !exists(json, 'features')
      ? undefined
      : (json['features'] as Array<any>).map(PlanFeatureRequestFromJSON),
...
export function PatchedPlanRequestToJSON(
  value?: PatchedPlanRequest | null
): any {
  if (value === undefined) {
    return undefined
  }
  ...
  return {
    ...
    features:
      value.features === undefined
        ? undefined
        : (value.features as Array<any>).map(PlanFeatureRequestToJSON),
    teams_access:
