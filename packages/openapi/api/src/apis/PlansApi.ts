...
export class PlansApi extends runtime.BaseAPI {
   ...
   */
  async plansV1CreateRaw(
    requestParameters: PlansV1CreateRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<Plan>> {
    if (
      requestParameters.planRequest === null ||
      requestParameters.planRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'planRequest',
        'Required parameter requestParameters.planRequest was null or undefined when calling plansV1Create.'
      )
    }
  ...
  async plansV1Create(
    ...
    const response = await this.plansV1CreateRaw(
      requestParameters,
      initOverrides
    )
  ...
  /**
   */
  async plansV1DestroyRaw(
    requestParameters: PlansV1DestroyRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling plansV1Destroy.'
      )
    }
  ...
  /**
   */
  async plansV1ListRaw(
    requestParameters: PlansV1ListRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<PaginatedPlanList>> {
    const queryParameters: any = {}
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PaginatedPlanListFromJSON(jsonValue)
    )
  }
  ...
  /**
   */
  async plansV1PartialUpdateRaw(
    requestParameters: PlansV1PartialUpdateRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<Plan>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling plansV1PartialUpdate.'
      )
    }
  ...
  /**
   */
  async plansV1PartialUpdate(
    requestParameters: PlansV1PartialUpdateRequest,
    initOverrides?: RequestInit
  ): Promise<Plan> {
    const response = await this.plansV1PartialUpdateRaw(
      requestParameters,
      initOverrides
    )
    return await response.value()
  ...
  /**
   */
  async plansV1RetrieveRaw(
    requestParameters: PlansV1RetrieveRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<Plan>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling plansV1Retrieve.'
      )
    }
  ...
  /**
   */
  async plansV1Retrieve(
    requestParameters: PlansV1RetrieveRequest,
    initOverrides?: RequestInit
  ): Promise<Plan> {
    const response = await this.plansV1RetrieveRaw(
      requestParameters,
      initOverrides
    )
    return await response.value()
  ...
  async plansV1UpdateRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling plansV1Update.'
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'planRequest',
        'Required parameter requestParameters.planRequest was null or undefined when calling plansV1Update.'
      )
    }
  ...
  async plansV1Update(
    ...
    const response = await this.plansV1UpdateRaw(
      requestParameters,
      initOverrides
    )
    return await response.value()
